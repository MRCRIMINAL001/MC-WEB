...
Created By : \033[1;96mrcriminal |\033[1;0m [V 1.2.2]

\033[1;32m------------------------------------------   
\33[93m AUTHOR  : Shadow Force
\33[93m TELEGRAM  : @MrCriminaL01
\33[93m Mail    :mrcriminal.me@gmail.com
\033[1;32m------------------------------------------   
"""
os.system('clear')
print(logo)
...
def up_chker():
    ...
    if r != ver:
       ...
       os.system('xdg-open https://www.facebook.com/SALMANCEOFB')
       exit()
